    ...
    <section className="relative">
      <Container reveal={!isMobile} bgGlow py="lg">
        <MaxWidthWrapper reveal={!isMobile} size="lg" px="md" align="center">
          ...
          {isMobile ? (
            <ol className="mx-auto mt-10 grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {steps.map((s, i) => (
                <li key={s.title} className="group relative">
                  <div className="relative h-full rounded-2xl border border-white/10 bg-neutral-950/60 p-5 backdrop-blur">
